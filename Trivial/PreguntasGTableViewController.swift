//
//  PreguntasGTableViewController.swift
//  Trivial
//
...
class PreguntasGTableViewController: UITableViewController {
    @IBAction func Volver(_ sender: Any) {
         dismiss(animated: true, completion: nil)
    }
    
    @IBAction func Volver2(_ sender: UIButton!) {
        print("algo")
    }
    ...
    private func CargarPreguntas(){
        ...
        guard let pregunta1 = Pregunta(nombre: "Informática", foto: nil, categoria: "algo", R1: true, R2: false, R3: false, R4: false) else {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let categorias = preguntas[indexPath.row]
        
        cell.nombrePregunta.text = categorias.nombre
